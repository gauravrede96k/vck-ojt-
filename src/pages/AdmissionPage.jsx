...
const Admission = () =>{
    return(
        ...
        <div className="admissions-container">
          ...
          <p>For detailed information on postgraduate program admissions, specific program syllabus, and fee structures, please visit our <Link to="/courses">Courses page</Link> or <Link to="/contact">Contact us</Link> directly.</p>
        </div>
        </div>
    );
};
